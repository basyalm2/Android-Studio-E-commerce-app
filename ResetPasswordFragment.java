...
public class ResetPasswordFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        emailIcon = view.findViewById(R.id.forgotpassword_emailicon);
        emailIconText = view.findViewById(R.id.forgot_password_emailicon_text);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        resetPasswordBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                resetPasswordBtn.setTextColor(getResources().getColor(R.color.text1));
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    scaleAnimation.setAnimationListener(new Animation.AnimationListener() {
                                        ...
                                        public void onAnimationEnd(Animation animation) {
                                            emailIconText.setText("Recovery email sent sucessfully ! check your Inbox!");
                                        ...
                                        public void onAnimationRepeat(Animation animation) {
                                            emailIcon.setImageResource(R.mipmap.sentemail);
                                    ...
                                    resetPasswordBtn.setTextColor(getResources().getColor(R.color.text));
